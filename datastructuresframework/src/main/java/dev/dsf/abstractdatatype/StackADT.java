...
/**
 * A stack is a linear abstract data type that follows the Last In, First Out
 * (LIFO) principle meaning that the last element added to this stack will be
 * the first one to be removed from it.
 * <p>
 * 
 * The common operations for a stack include:
 * <p>
 * <ul>
